...
go
INSERT INTO TAIKHOAN VALUES ('admin', '');
...
INSERT INTO SACH (MASACH, TENSACH, MATG, MALOAISACH, GIABAN, GIANHAP, LANTAIBAN, MANXB, NAMXUATBAN)
VALUES
('S001', 'Harry Potter', 'TG002', 'LS001', 200000, 150000, 5, 'NXB002', 1997),
('S002', '1984', 'TG003', 'LS003', 180000, 140000, 3, 'NXB003', 1949),
('S003', 'Kafka on the Shore', 'TG004', 'LS001', 220000, 180000, 2, 'NXB001', 2002),
('S004', 'Sapiens', 'TG005', 'LS003', 250000, 200000, 4, 'NXB005', 2011),
('S005', 'Mat Biec', 'TG001', 'LS001', 150000, 120000, 6, 'NXB004', 1990);


INSERT INTO KHO (MASACH, SOLUONG)
VALUES
('S001', 100),
('S002', 80),
('S003', 150),
